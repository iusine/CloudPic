package com.github.cloudpic.service.impl;
...
import com.github.cloudpic.mapper.UserMapper;
...
import static com.github.cloudpic.constant.UserConstant.LOGGING_STATE;
...
public class UserServiceImpl extends ServiceImpl<UserMapper, User>
    ...
    public long userRegister(UserRegisterRequest userRegisterRequest) {
        ...
        //插入数据
        User user = new User();
        user.setUserAvatar("https://jsd.onmicrosoft.cn/gh/iusie/image/user.svg");
     ...
     */
    @Override
    public User getgetLoggingUser(HttpServletRequest request) {
    ...
    public LoggingUserVO getLoggingUserVO(User user) {
        ...
        BeanUtil.copyProperties(user, loggingUserVO);
        return loggingUserVO;
    }
