...
/** 此处后端没有提供注释 GET /user/get/logging */
export async function getLoggingUser(options?: { [key: string]: any }) {
  return request<API.BaseResponseLoggingUserVO>('/user/get/logging', {
    method: 'GET',
    ...(options || {}),
  })
}
...
export async function userLogin(body: API.UserLoginRequest, options?: { [key: string]: any }) {
  return request<API.BaseResponseLoggingUserVO>('/user/login', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
